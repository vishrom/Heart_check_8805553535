...
from kivy.propertis import BooleanProperty,  NumericProperty
...
class Runner(BoxLayout):
    ...
    def __init__(self,
                total = 10, steptime = 1, autorepeat = True, bcolor = (0.73, 0.15, 0.96, 1), btext_inprogress = 'Приседания', **kwargs):
        ...
        self.btn = Button(size_hint(1:1.0), pos_hint= {'top':1.0}, background = bcolor)
